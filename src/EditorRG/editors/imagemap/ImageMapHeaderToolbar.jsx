            ...
            <Flex className="rde-editor-header-toolbar-container" flex="1">
                ...
                <Flex.Item className="rde-canvas-toolbar rde-canvas-toolbar-alignment">
                    <CommonButton
                        ...
                        disabled={isCropping}
                        onClick={() =>
                            canvasRef.handler?.alignmentHandler.left()
                        }
                        icon="align-left"
                    ...
                    <CommonButton
                        ...
                        disabled={isCropping}
                        onClick={() =>
                            canvasRef.handler?.alignmentHandler.center()
                        }
                        icon="align-center"
                    ...
                    <CommonButton
                        ...
                        disabled={isCropping}
                        onClick={() =>
                            canvasRef.handler?.alignmentHandler.right()
                        }
                        icon="align-right"
                ...
                <Flex.Item className="rde-canvas-toolbar rde-canvas-toolbar-crop">
                    <CommonButton
                        ...
                        disabled={
                            canvasRef
                                ? !canvasRef.handler?.cropHandler.validType()
                                : true
                        }
                    ...
                    <CommonButton
                        ...
                        disabled={
                            canvasRef
                                ? !canvasRef.handler?.cropHandler.cropRect
                                : true
                        }
                ...
                <Flex.Item className="rde-canvas-toolbar rde-canvas-toolbar-history">
                    <CommonButton
                        ...
                        disabled={
                            isCropping ||
                            (canvasRef &&
                                !canvasRef.handler?.transactionHandler.undos
                                    .length)
                        }
                        onClick={() =>
                    ...
                    <CommonButton
                        ...
                        disabled={
                            isCropping ||
                            (canvasRef &&
                                !canvasRef.handler?.transactionHandler.redos
                                    .length)
                        }
                        onClick={() =>
