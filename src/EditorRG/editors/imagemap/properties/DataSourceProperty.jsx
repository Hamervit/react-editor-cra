                        ...
                        <Form.Item label="Playback" colon={false}>
                            <Row>
                                <Col span={8}>
                                    <Button
                                        onClick={() => {
                                            canvasRef.handler.animationHandler.play(
                                                data.id
                                            );
                                        }}
                                    >
                                ...
                                <Col span={8}>
                                    <Button
                                        onClick={() => {
                                            canvasRef.handler.animationHandler.pause(
                                                data.id
                                            );
                                        }}
                                    >
                                ...
                                <Col span={8}>
                                    <Button
                                        onClick={() => {
                                            canvasRef.handler.animationHandler.stop(
                                                data.id
                                            );
                                        }}
                                    >
                    ...
                    <Col span={12}>
                        <Form.Item label="Stroke Color" colon={false}>
                            {getFieldDecorator("animation.stroke", {
                                initialValue:
                                    data.animation.stroke || data.stroke,
                            })(<ColorPicker />)}
                        </Form.Item>
                    </Col>
                </Row>
